...
const ko = {
  ...
  about: {
    ...
    /**
     * 연혁 — 회사가 어디서 시작해 어디로 왔는지
     *
     * ⚠ 연도를 지어내지 않았습니다. 확인된 날짜는 설립일(사업자등록증) 하나뿐입니다.
     *   회사소개서(2025.04) IV장의 실적에는 연도가 없어, 설립 이후 그 문서가 나오기까지의
     *   구간으로만 묶어 「2022 – 2025」로 적었습니다. 그 사이에 있었다는 것은 확실합니다.
     *
     * TODO(연혁): 각 실적의 실제 연도를 확인하면 항목을 쪼개고 연도를 넣습니다.
     *   그때 이 목록이 진짜 연혁이 됩니다. 지금은 흐름만 보여줍니다.
     */
    history: {
      label: 'HISTORY',
      heading: '유지보수에서 시작해, 플랫폼까지',
      lead: '남의 솔루션을 맡아 운영하던 회사가 자기 플랫폼을 갖기까지의 순서입니다.',
      nowLabel: '현재',
      items: [
        {
          id: 'founded',
          period: '2022.03',
          title: '주식회사 인포패스 설립',
          body: '제조 현장의 MES를 다루는 전문기업으로 출발했습니다.',
        },
        {
          id: 'operate',
          period: '2022 – 2025',
        ...
        },
        {
          ...
          period: '2022 – 2025',
          title: '구축으로 넓혔습니다',
          body: '해외 생산라인 MES 구축 프로젝트에 참여하고, AI 기반 품질데이터 분석 시스템을 직접 구축했습니다.',
        },
        {
          id: 'platform',
          period: '',
          title: '자체 플랫폼 INFOLINK',
          body: '이제 백지에서 시작하지 않습니다. 8단계 전 공정이 구현된 플랫폼 위에서 현장에 맞춰 구축합니다.',
        },
      ],
    },
